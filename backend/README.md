...
## Project Structure
    ...
    ├── testapiautoconnect_116430  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_116430`
...
2. Clone this repo and `cd testapiautoconnect_116430`
